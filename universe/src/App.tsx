                ...
                <Route path='/' element={
                    <>
                        ...
                        <Styled.Section className='headline'>
                            ...
                            <p>by Jack Pickett - London & Cornwall - October / November 2025</p>
                            <p>Introducing a single, universal gravitational law...</p>
                            <div>
                        ...
                        <Styled.Section style={{ backgroundColor: '#FFF' }}>
                            ...
                            {/* <p>Define <InlineMath math="\kappa_G" /> and the collision term:</p>
                            <BlockMath math={String.raw`
                            \kappa_G = \kappa_{G,\text{base}} + \kappa_{G,\text{coll}},\quad
                            \kappa_{G,\text{coll}} = k_v \left( \frac{\nabla v_{\text{rel}}}{10^{-12}\,\mathrm{s}^{-1}} \right)^{3}
                            \left( \frac{\rho}{\rho_0} \right)^{0.5},\quad
                            k_v \approx 5\times 10^{-26}\,\mathrm{m}^{-1}.
                            `} /> */}
                        </Styled.Section>
                        <Styled.Section style={{ backgroundColor: 'rgba(0,0,0,0.6)', color: '#FFF' }}>
                            ...
                            {/* <div>
                                <BlockMath math={String.raw`
                                    \kappa\;\approx\;1.7\times10^{-21}\ \text{m}^{-1}
                                `} />
                            </div> */}
                        </Styled.Section>
                        <Styled.Section style={{ backgroundColor: '#F6F6F6' }}>
