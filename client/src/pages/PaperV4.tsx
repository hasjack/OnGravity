...
const CurvatureResponseModel = () => {
    return (
        ...
        >
            ...
            <Latex math={String.raw`f'(R) R_{\mu\nu} - \frac{1}{2} f(R) g_{\mu\nu} - \nabla_\mu \nabla_\nu f'(R) + g_{\mu\nu} \Box f'(R) = 8\pi G \, T_{\mu\nu}`} />
            ...
            <Latex math={String.raw`S = \int \sqrt{-g} [R \exp(\alpha R) + 16\pi G L_m],d^4x`} />
            ...
            <Latex math={String.raw`\mathbf{g} = -\nabla \Phi,`} />
            ...
            <Latex math={String.raw`\Phi_{\mathrm{eff}}(r) = -\frac{GM}{r}\,e^{\kappa(r)\,r}`} />

            <P classNames="mb-0">which produces the radial acceleration</P>
            <Latex math={String.raw`g_{\mathrm{eff}}(r) = \frac{GM}{r^{2}}\,e^{\kappa(r)\,r}`} />

            <P classNames="mb-0">The circular velocity in an axisymmetric system follows from</P>
            <Latex math={String.raw`v_{\kappa}(r) = \sqrt{\frac{GM(r)}{r}}\,e^{\kappa(r)\,r/2}`} />
            ...
            <Latex math={String.raw`\kappa(\rho, r) = \kappa_{0} + k_{v} \left( \frac{\partial v / \partial r} {10^{-12}\,\mathrm{s}^{-1}} \right)^{3} \left( \frac{\rho}{\rho_{0}} \right)^{1/2}`} />
            ...
            <Latex math={String.raw`\kappa_{0} = 2.6 \times 10^{-26}\ \mathrm{m}^{-1},\ k_{v} = 5 \times 10^{-26}\ \mathrm{m}^{-1},\ \rho_{0} = 1600\ \mathrm{kg\,m^{-3}}`} />
            ...
            <Latex math={String.raw`g(r) \simeq \frac{GM}{r^2}`} />
            <P>
            ...
            <Latex math={String.raw`\rho = 10^{-12}\ \text{kg m}^{-3}`} />
            ...
            <Latex math={String.raw`v_{\mathrm{obs}}(r) = v_N(r)\exp\left(\frac{\kappa(r)\,r}{2}\right)`} />
            ...
            <Latex math={String.raw`\frac{\kappa(r)\,r}{2} = \ln\left(\frac{v_{\mathrm{obs}}}{v_N}\right)`} />
            ...
            <Latex math={String.raw`g_{\mathrm{bar}} = \frac{v_N^2}{r}`} />
            <P classNames="mb-0">The empirical relation is well described by</P>
            <Latex math={String.raw`\frac{\kappa r}{2} = a + b\,\log_{10}(g_{\mathrm{bar}})`} />
            <P classNames="mb-0">with an extended model including shear</P>
            <Latex math={String.raw`\frac{\kappa r}{2} = a + b\,\log_{10}(g_{\mathrm{bar}}) + c\,\log_{10}\left(\frac{dv}{dr}\right)`} />
            ...
            <Latex math={String.raw`v_{\mathrm{pred}} = v_N \exp\left(\frac{\kappa r}{2}\right)`} />
            <P>
            ...
            <Latex math={String.raw`g_{\mathrm{obs}} = \frac{v_{\mathrm{obs}}^2}{r}`} />
            <P>
            ...
            <Latex math={String.raw`\Phi_\kappa(r)=-\frac{GM(r)}{r}\,e^{\kappa(r)\,r}`} />
            ...
            <Latex math={String.raw`g_r(r) = \frac{GM(r)}{r^2}\,e^{\kappa(r)\,r}`} />
            ...
            <Latex math={String.raw`\kappa(r)=\kappa_0 + k_v \left(\frac{\partial v/\partial r}{10^{-12}\,\mathrm{s}^{-1}}\right)^3 \left(\frac{\rho(r)}{\rho_0}\right)^{1/2}.`} />
            <P>
            ...
            <Latex math={String.raw`\kappa \approx 3.4 \times 10^{-15}\,\mathrm{m^{-1}},\ e^{\kappa r} \approx 1.00000000034`} />
            ...
            <Latex math={String.raw`\kappa(r) = \kappa_0 \;+\; k_v \left( \frac{\partial v/\partial r}{10^{-12}\ \mathrm{s^{-1}}} \right)^{\!3} \left( \frac{\rho}{\rho_0} \right)^{\!1/2}.`} />
            ...
            <Latex math={String.raw`g_\kappa(r) \,=\, \frac{GM(r)}{r^2}\, e^{\kappa(r) r},`} />
            ...
            <Latex math={String.raw`e^{\kappa(r) r}`} />
            <P>
            ...
            <Latex math={String.raw`\kappa_{\mathrm{shear}} = k_v \left(\frac{|\partial v_{\mathrm{rel}}/\partial r|}{10^{-12}\,\mathrm{s}^{-1}}\right)^3 \left(\frac{\rho}{\rho_0}\right)^{1/2}.`} />

            <H4>Result</H4>
            <P classNames="mb-0">For typical merging-cluster geometries (impact parameters 100-300 kpc):</P>
            <Latex math={String.raw`\kappa r \sim 1`} />
            <P>producing:</P>
            <Ul>
            ...
            <Latex math={String.raw`\kappa \;=\; \kappa_{\rm base} \,+\, \kappa_{\rm coll},`} />

            <P classNames="mb-0">where the collision-driven contribution is</P>
            <Latex math={String.raw`\kappa_{\rm coll} = k_{v} \left( \frac{\nabla v_{\rm rel}}{10^{-12}\,\mathrm{s^{-1}}} \right)^{3} \left( \frac{\rho}{\rho_{0}} \right)^{1/2},`} />
            <Latex math={String.raw`k_v \approx 5\times 10^{-26}\,\mathrm{m^{-1}},\; \rho_0 = 1600\,\mathrm{kg\,m^{-3}}.`} />
            ...
            <Latex math={String.raw`\Phi_{\kappa}(r) = -\frac{GM}{r}\,e^{\kappa r},`} />

            <P classNames="mb-0">the associated deflection angle is similarly multiplied:</P>
            <Latex math={String.raw`\alpha_{\kappa}(b) = \alpha_{\rm GR}(b)\,e^{\kappa b/2}.`} />
            ...
            <Latex math={String.raw`\epsilon_{\mathrm{GR}}(r) = \frac{GM}{c^{2} r},`} />
            ...
            <Latex math={String.raw`\epsilon_{\kappa}(r) = \kappa(r)\,r,`} />
            ...
            <Latex math={String.raw`\epsilon_{\kappa}(r) \gtrsim \epsilon_{\mathrm{GR}}(r),`} />
            <P>
            ...
            <Latex math={String.raw`e^{\kappa(r)\,r} \simeq 1, \qquad E_{\kappa} \simeq mc^2,`} />
            ...
            <Latex math={String.raw`\Phi(r) = -\frac{GM}{r}\,e^{\kappa(r)\,r}, \qquad \lim_{r \to \ell_P} \Phi(r) = -\frac{GM}{r}.`} />
            ...
            <Latex math={String.raw`E_{\kappa}(r) = mc^{2} e^{\kappa(r)\,r}, \qquad \lim_{r \to 0} E_{\kappa}(r) = mc^{2}.`} />
            ...
            <Latex math={String.raw`S = \int \sqrt{-g} \left[ f(R) + 16\pi G L_m \right] d^4x,`} />
            <P classNames="mb-0">is modified with</P>
            <Latex math={String.raw`f(R) = R \exp(\alpha R),`} />
            <P classNames="mb-0">
            ...
            <Latex math={String.raw`f(R) = R e^{\alpha R} \;\approx\; R + \alpha R^{2},`} />

            <P classNames="mb-0">
                with derivative
            </P>
            <Latex math={String.raw`f'(R) = \frac{d f}{dR} = e^{\alpha R}(1+\alpha R) \;\approx\; 1 + 2\alpha R.`} />
            ...
            <Latex math={String.raw`g_{00} \approx -(1 + 2\Phi),`} />
            ...
            <Latex math={String.raw`\mu(r) \equiv f'(R(r)),`} />
            ...
            <Latex math={String.raw`\Phi(r) = -\frac{GM}{r} e^{\kappa(r)\,r}`} />

            <P classNames="mb-0">and corresponding acceleration</P>
            <Latex math={String.raw`g(r) = \frac{GM}{r^2} e^{\kappa(r)\,r}.`} />
            ...
            <Latex math={String.raw`\frac{v_\kappa^{2}}{r} = \frac{GM}{r^{2}}\,e^{\kappa r}.`} />

            <P classNames="mb-0">Solving for the orbital velocity,</P>
            <Latex math={String.raw`v_\kappa(r) = \sqrt{\frac{GM}{r}}\, e^{\kappa r / 2}.`} />

            <P classNames="mb-0">The Newtonian prediction from baryons alone is</P>
            <Latex math={String.raw`v_N(r)=\sqrt{\frac{GM}{r}}.`} />

            <P classNames="mb-0">The ratio between the observed orbital speed</P>
            <Latex math={String.raw`v_{\rm obs}(r)`} />
            ...
            <Latex math={String.raw`\frac{v_{\rm obs}}{v_N}=e^{\kappa(r) r/2}.`} />

            <P classNames="mb-0">Solving for <InlineMath math={String.raw`\kappa(r)`} /> yields</P>
            <Latex math={String.raw`\kappa(r)=\frac{2}{r}\, \ln\!\left( \frac{v_{\rm obs}(r)}{v_N(r)} \right).`} />
            ...
            <Latex math={String.raw`\kappa(r) = \kappa_{0} \;+\; k_{v} \left( \frac{\partial v/\partial r}{10^{-12}\,\mathrm{s}^{-1}} \right)^{3} \left( \frac{\rho}{\rho_{0}} \right)^{1/2}.`} />
            ...
            <Latex math={String.raw`\kappa(r) = \kappa_{0} + k_{v} \left( \frac{\partial v/\partial r}{10^{-12}\ \mathrm{s^{-1}}} \right)^{3} \left( \frac{\rho}{\rho_0} \right)^{1/2}.`} />
            ...
            <Latex math={String.raw`\kappa(r)\,r \;\gtrsim\;1. `} />

            <P classNames="mb-0">Substituting the scaling <InlineMath math={String.raw`\kappa ∼ r⁻⁶`} />:</P>
            <Latex math={String.raw`\kappa(r)\,r \;\sim\; r^{-5}.`} />
            ...
            <Latex math={String.raw`\kappa(r_\mathrm{crit})\,r_\mathrm{crit} = 1.`} />

            <P classNames="mb-0">For <InlineMath math={String.raw`r < r_\mathrm{crit}`} />, the exponential steepening dominates the dynamics:</P>
            <Latex math={String.raw`g_\kappa(r) \;\approx\; \frac{GM}{r^{2}} \exp(r^{-5}) ,`} />
            ...
            <Latex math={String.raw`\kappa_{\rm coll} \approx (1\!-\!5)\times10^{-23}\,\mathrm{m^{-1}},`} />

            <P classNames="mb-0">consistent with the transient increases used in the main text. The lensing deflection becomes:</P>
            <Latex math={String.raw`\alpha_{\rm eff}(b) = \alpha_{\rm GR}(b)\,e^{\frac{1}{2}(\kappa_{\rm base}+\kappa_{\rm coll})b}.`} />

            <P classNames="mb-0">For a representative impact parameter <InlineMath math={String.raw`b\approx 200\,\mathrm{kpc}`} />:</P>
            <Latex math={String.raw`\kappa_{\rm coll}b \sim 10^{-2}, \qquad e^{\kappa_{\rm coll} b /2} \approx 1.005\!-\!1.015.`} />
            ...
            <Latex math={String.raw`g_\kappa(r)=\frac{GM}{r^{2}}\,e^{\kappa r}.`} />

            <P classNames="mb-0">In spherical inflow, the Bondi accretion rate is</P>
            <Latex math={String.raw`\dot M_{\rm Bondi} =4\pi\lambda\,\frac{(GM)^2\rho_\infty}{c_s^3},`} />
            ...
            <Latex math={String.raw`G \;\longrightarrow\; G_{\rm eff}(r) = G\,e^{\kappa r}.`} />
            ...
            <Latex math={String.raw`\dot M_\kappa \;=\; \dot M_{\rm Bondi}\,e^{2\kappa r}.`} />
            ...
            <Latex math={String.raw`\dot M_\kappa = \dot M_{\rm Bondi}\, \exp\!\left(\frac{4GM\kappa}{c^2}\right)`} />
            ...
            <Latex math={String.raw`e^{4\kappa r_s} \sim 3\!-\!30.`} />
            ...
            <Latex math={String.raw`\dot{M}_{\rm Edd} = \frac{M}{t_{\rm Sal}}, \qquad t_{\rm Sal} \simeq 4.5 \times 10^{7}\ {\rm yr}.`} />

            <P classNames="mb-0">In the <InlineMath math={String.raw`\kappa`} />-framework this is replaced by</P>
            <Latex math={String.raw`\dot{M} = \frac{M}{t_{\rm Sal}}\,e^{2\kappa r_s}.`} />

            <P classNames="mb-0">Thus the integrated mass evolution becomes</P>
            <Latex math={String.raw`M(t) = M_0\,\exp\!\left[\frac{t}{t_{\rm Sal}}\,e^{2\kappa r_s}\right].`} />
            ...
            <Latex math={String.raw`t_{\rm eff} = \frac{t_{\rm Sal}}{5} \simeq 9\,{\rm Myr}.`} />
            ...
            <Latex math={String.raw`\alpha_{\rm GR}(b)=\frac{4GM}{c^{2} b}.`} />
            ...
            <Latex math={String.raw`\alpha_{\rm eff}(b) = \alpha_{\rm GR}(b)\,e^{\kappa b/2} = \left(\frac{4GM}{c^{2} b}\right)e^{\kappa b/2}.`} />

            <P classNames="mb-0">For <InlineMath math={String.raw`\kappa b \ll 1`} />, the exponential expands to</P>
            <Latex math={String.raw`\alpha_{\rm eff}(b) \approx \alpha_{\rm GR}(b)\bigl(1+\tfrac{1}{2}\kappa b\bigr),`} />
            ...
            <Latex math={String.raw`g_{\kappa}(r) = \frac{GM}{r^{2}} \left( \frac{m_{\mathrm{grav}}(r)}{m} \right), \qquad m_{\mathrm{grav}}(r) = m\,e^{\kappa r}.`} />
            ...
            <Latex math={String.raw`\lim_{r \to 0} E_{\kappa}(r) = mc^{2}.`} />
            ...
            <Latex math={String.raw`\Phi_{\kappa}(r) = -\,\frac{GM}{r}\,e^{\kappa(r)\,r}.`} />
            ...
            <Latex math={String.raw`e^{\kappa(r)\,r} = 1 + \kappa(r)\,r + \tfrac{1}{2}\kappa(r)^{2} r^{2} + \mathcal{O}(r^{3}).`} />

            <P classNames="mb-0">Substituting:</P>
            <Latex math={String.raw`\Phi_{\kappa}(r) = -\frac{GM}{r}\Big[ 1 + \kappa(r)\,r + \tfrac{1}{2}\kappa(r)^{2}r^{2} + \mathcal{O}(r^{3}) \Big].`} />

            <P classNames="mb-0">Expanding term-by-term:</P>
            <Latex math={String.raw`\Phi_{\kappa}(r) = -\frac{GM}{r} \;-\; GM\,\kappa(r) \;-\; \tfrac{1}{2}GM\,\kappa(r)^{2}r \;+\; \mathcal{O}(r^{2}).`} />
            ...
            <Latex math={String.raw`\lim_{r\to \ell_P} \kappa(r) = 0, \qquad \lim_{r\to \ell_P} \Phi_{\kappa}(r) = -\frac{GM}{r}.`} />
            ...
            <Latex math={String.raw`E_{\kappa}(r) = m c^{2} e^{\kappa(r) r}.`} />

            <P classNames="mb-0">Expanding:</P>
            <Latex math={String.raw`E_{\kappa}(r) = mc^{2}\Big[ 1 + \kappa(r) r + \tfrac{1}{2}\kappa(r)^{2}r^{2} + \mathcal{O}(r^{3}) \Big].`} />

            <P classNames="mb-0">Thus,</P>
            <Latex math={String.raw`\lim_{r\to \ell_P} E_{\kappa}(r) = mc^{2}.`} />
...
export default CurvatureResponseModel